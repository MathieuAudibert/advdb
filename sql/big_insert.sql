...
DROP SEQUENCE iatype_seq;
DROP SEQUENCE cfg_seq;
DROP SEQUENCE specs_seq;
DROP SEQUENCE iagen_seq;

DROP TABLE logs_ia CASCADE CONSTRAINTS PURGE;
DROP TABLE company CASCADE CONSTRAINTS PURGE;
DROP TABLE IA_Type CASCADE CONSTRAINTS PURGE;
DROP TABLE Config CASCADE CONSTRAINTS PURGE;
DROP TABLE Specs CASCADE CONSTRAINTS PURGE;
DROP TABLE IA_Gen CASCADE CONSTRAINTS PURGE;
